...
void CreateMelee(int client)
{
	...
	CreateTimer(0.1, TimerThrowMelee, GetClientUserId(client));
}

Action TimerThrowMelee(Handle timer, int client)
{
...
Action TimerRender(Handle timer, int weapon)
{
...
Action TimerGlow(Handle timer, int weapon)
{
	if( EntRefToEntIndex(weapon) != INVALID_ENT_REFERENCE )
	{
...
Action TimerPos(Handle timer, int entity)
{
...
Action TimerCheck(Handle timer, int weapon)
{
