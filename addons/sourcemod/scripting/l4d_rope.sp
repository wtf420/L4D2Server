...
public void OnPluginStart() { 	 
	...
	Rope_chance_witch =	CreateConVar("rope_chance_witch", "100.0", "chance of witch loot 100:certainly", FCVAR_NOTIFY);
 	Rope_chance_tank =	CreateConVar("rope_chance_tank", "100.0", "chance of tank loot 100:certainly", FCVAR_NOTIFY);
	Rope_chance_hook =	CreateConVar("rope_chance_hook", "100", "chance to get hook if looted from witch&tank", FCVAR_NOTIFY);
