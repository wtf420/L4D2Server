...
enum struct PluginCvars
{
	...
	ConVar l4d_superboss_postspawn_delay;
	ConVar l4d_invisible_postspawn_delay;

	void Init()
	{
		bossname[ZOMBIECLASS_TANK] = "tank";

		this.l4d_superboss_plugin_enable = CreateConVar("l4d_superboss_plugin_enable", "1", "super infected plugin (0=Disable, 1=Enable)", CVAR_FLAGS);
		this.l4d_superboss_enable = CreateConVar("l4d_superboss_enable", "1", "Enable super SI (0=Disable, 1=Enable)", CVAR_FLAGS);
		this.l4d_invisible_enable = CreateConVar("l4d_invisible_enable", "1", "Enable invisible SI (0=Disable, 1=Enable)", CVAR_FLAGS);

		this.l4d_superboss_print = CreateConVar("l4d_superboss_print", "1", "Print chat message when a super SI spawn (0=Disable, 1=Enable)", CVAR_FLAGS);
		this.l4d_invisible_print = CreateConVar("l4d_invisible_print", "1", "Print chat message when an invisible SI spawn (0=Disable, 1=Enable)", CVAR_FLAGS);

		this.l4d_superboss_postspawn_delay = CreateConVar("l4d_superboss_postspawn_delay", "0", "Delay after spawn before turning this SI into a super SI (in seconds)", CVAR_FLAGS);
		this.l4d_invisible_postspawn_delay = CreateConVar("l4d_invisible_postspawn_delay", "0", "Delay after spawn before turning this SI into an invisible SI (in seconds)", CVAR_FLAGS);	

		this.l4d_super_probability[ZOMBIECLASS_HUNTER]  = CreateConVar("l4d_super_probability_hunter", "8.0", "Probalility of this SI become a super SI (0 - 100)", CVAR_FLAGS);
		this.l4d_super_probability[ZOMBIECLASS_SMOKER]  = CreateConVar("l4d_super_probability_smoker", "8.0", "", CVAR_FLAGS);	
		this.l4d_super_probability[ZOMBIECLASS_BOOMER]  = CreateConVar("l4d_super_probability_boomer", "8.0", "", CVAR_FLAGS);
		this.l4d_super_probability[ZOMBIECLASS_JOCKEY]  = CreateConVar("l4d_super_probability_jockey", "8.0", "", CVAR_FLAGS);
		this.l4d_super_probability[ZOMBIECLASS_SPITTER] = CreateConVar("l4d_super_probability_spitter", "8.0", "", CVAR_FLAGS);
		this.l4d_super_probability[ZOMBIECLASS_CHARGER] = CreateConVar("l4d_super_probability_charger", "8.0", "", CVAR_FLAGS);
		this.l4d_super_probability[ZOMBIECLASS_TANK] = CreateConVar("l4d_super_probability_tank", "5.0", "", CVAR_FLAGS);
	 
		this.l4d_invisible_probability[ZOMBIECLASS_HUNTER]  = CreateConVar("l4d_invisible_hunter", "25.0", "Probalility of this SI become an invisible SI (0 - 100)", CVAR_FLAGS);
		this.l4d_invisible_probability[ZOMBIECLASS_SMOKER]  = CreateConVar("l4d_invisible_smoker", "30.0", "", CVAR_FLAGS);	
		this.l4d_invisible_probability[ZOMBIECLASS_BOOMER]  = CreateConVar("l4d_invisible_boomer", "20.0", "", CVAR_FLAGS);
		this.l4d_invisible_probability[ZOMBIECLASS_JOCKEY]  = CreateConVar("l4d_invisible_jockey", "20.0", "", CVAR_FLAGS);
		this.l4d_invisible_probability[ZOMBIECLASS_SPITTER] = CreateConVar("l4d_invisible_spitter", "50.0", "", CVAR_FLAGS);
		this.l4d_invisible_probability[ZOMBIECLASS_CHARGER] = CreateConVar("l4d_invisible_charger", "20.0", "", CVAR_FLAGS);
		this.l4d_invisible_probability[ZOMBIECLASS_TANK] = CreateConVar("l4d_invisible_tank", "4.0", "", CVAR_FLAGS);

		this.l4d_invisible_alpha  =	 CreateConVar("l4d_invisible_alpha", "90", "0, Completely invisible, 255, Completely visible [0, 255]", CVAR_FLAGS);

		this.l4d_super_HPmultiple[ZOMBIECLASS_HUNTER]  =  CreateConVar("l4d_super_HPmultiple_hunter", "5.0", "Health multiplier of this super SI (0.5 - 20.0)", CVAR_FLAGS);
		this.l4d_super_HPmultiple[ZOMBIECLASS_SMOKER]  =  CreateConVar("l4d_super_HPmultiple_smoker", "5.0", "", CVAR_FLAGS);
		this.l4d_super_HPmultiple[ZOMBIECLASS_BOOMER]  =  CreateConVar("l4d_super_HPmultiple_boomer", "5.0", "", CVAR_FLAGS);
		this.l4d_super_HPmultiple[ZOMBIECLASS_JOCKEY]  =  CreateConVar("l4d_super_HPmultiple_jockey", "5.0", "", CVAR_FLAGS);
		this.l4d_super_HPmultiple[ZOMBIECLASS_SPITTER]  = CreateConVar("l4d_super_HPmultiple_spitter", "5.0", "", CVAR_FLAGS);	
		this.l4d_super_HPmultiple[ZOMBIECLASS_CHARGER]  = CreateConVar("l4d_super_HPmultiple_charger", "5.0", "", CVAR_FLAGS);
		this.l4d_super_HPmultiple[ZOMBIECLASS_TANK]  = CreateConVar("l4d_super_HPmultiple_tank", "1.3", "", CVAR_FLAGS);

		this.l4d_super_movemultiple[ZOMBIECLASS_HUNTER]  =  CreateConVar("l4d_super_movemultiple_hunter", "1.3", "Movement speed multiplier of super SI (0.5 - 20)", CVAR_FLAGS);
		this.l4d_super_movemultiple[ZOMBIECLASS_SMOKER]  =  CreateConVar("l4d_super_movemultiple_smoker", "1.3", "", CVAR_FLAGS);	
		this.l4d_super_movemultiple[ZOMBIECLASS_BOOMER]  =  CreateConVar("l4d_super_movemultiple_boomer", "1.2", "", CVAR_FLAGS);
		this.l4d_super_movemultiple[ZOMBIECLASS_JOCKEY]  =  CreateConVar("l4d_super_movemultiple_jockey", "1.3", "", CVAR_FLAGS);
		this.l4d_super_movemultiple[ZOMBIECLASS_SPITTER]  = CreateConVar("l4d_super_movemultiple_spitter", "1.3", "", CVAR_FLAGS);	
		this.l4d_super_movemultiple[ZOMBIECLASS_CHARGER]  = CreateConVar("l4d_super_movemultiple_charger", "1.3", "", CVAR_FLAGS);
		this.l4d_super_movemultiple[ZOMBIECLASS_TANK]  = CreateConVar("l4d_super_movemultiple_tank", "1.15", "", CVAR_FLAGS); 

		this.l4d_super_catchfire[ZOMBIECLASS_HUNTER]  =  CreateConVar("l4d_super_catchfire_hunter", "10.0", "Probalility of this SI catching fire when spawning (0 - 100)", CVAR_FLAGS);
		this.l4d_super_catchfire[ZOMBIECLASS_SMOKER]  =  CreateConVar("l4d_super_catchfire_smoker", "10.0", "", CVAR_FLAGS);
		this.l4d_super_catchfire[ZOMBIECLASS_BOOMER]  =  CreateConVar("l4d_super_catchfire_boomer", "10.0", "", CVAR_FLAGS);
		this.l4d_super_catchfire[ZOMBIECLASS_JOCKEY]  =  CreateConVar("l4d_super_catchfire_jockey", "10.0", "", CVAR_FLAGS);
		this.l4d_super_catchfire[ZOMBIECLASS_SPITTER]  = CreateConVar("l4d_super_catchfire_spitter", "10.0", "", CVAR_FLAGS);	
		this.l4d_super_catchfire[ZOMBIECLASS_CHARGER]  = CreateConVar("l4d_super_catchfire_charger", "10.0", "", CVAR_FLAGS);
		this.l4d_super_catchfire[ZOMBIECLASS_TANK] =  CreateConVar("l4d_super_catchfire_tank", "0.0", "", CVAR_FLAGS);
    ...
    if(IsValidAliveInf(client))
    {
    	if(plugin.bSuperBossOn || plugin.bInvisBossOn)
    	{
    		...
    		if(plugin.bSuperBossOn)
    		{
    			...
    			{
    				CreateTimer(plugin.cvars.l4d_superboss_postspawn_delay.FloatValue, CreateSuperBoss, client);
    			}
    		}
    		...
    		if(plugin.bInvisBossOn)
    		{
    			...
    			{
    				CreateTimer(plugin.cvars.l4d_invisible_postspawn_delay.FloatValue, CreateInvisibleBoss, client);
    			}
    		}
    	}
    }
